        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="<?= base_url('shift/update/'.$shift['id']) ?>" method="post">
                                <?= csrf_field() ?>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Nama Shift</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="nm_shift" value="<?= $shift['nm_shift'] ?>" type="text" id="nm_shift" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Jam Piket</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="jam_piket" value="<?= $shift['jam_piket'] ?>" type="time" id="jam_piket" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Keterangan Jaga</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="ket_jaga" value="<?= $shift['ket_jaga'] ?>" type="text" id="ket_jaga" required>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <a href="<?= base_url('shift') ?>" class="btn btn-success waves-effect waves-light me-2">Kembali</a>
