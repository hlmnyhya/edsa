        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="unit/save" method="post">
                                <?= csrf_field(); ?>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Nama Unit</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="nm_unit" type="text" id="nm_unit" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Simbol Unit</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="simbol_unit" type="text" id="simbol_unit" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="<?= base_url('unit') ?>" type="submit" class="btn btn-success waves-effect waves-light me-2">Kembali</a>
