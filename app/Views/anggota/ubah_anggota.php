                            ...
                            <form action="<?= base_url('anggota/update/'.$anggota['id']) ?>" method="post">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="nm_anggota" type="text" value="<?= $anggota['nm_anggota'] ?>" id="nm_anggota" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">NRP</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" name="nrp" value="<?= $anggota['nrp'] ?>" type="text" id="nrp" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="pangkat" aria-label="Default select example" required>
                                                <option selected hidden value="<?= $anggota['pangkat'] ?>"><?= $anggota['pangkat'] ?></option>
                                                <option value="BRIGADIR">BRIGADIR</option>
                                                <option value="BRIBDA">BRIBDA</option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="id_jabatan" aria-label="Default select example" required>
                                                <option selected hidden value="<?= $anggota['id_jabatan'] ?>"><?= $anggota['simbol_jabatan'] ?></option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="tgl_lahir" value="<?= $anggota['tgl_lahir'] ?>" type="date" id="tgl_lahir" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="jk" aria-label="Default select example" required>
                                                <option selected hidden value="<?= $anggota['jk'] ?>"><?= $anggota['jk'] ?></option>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="<?= base_url('anggota') ?>" class="btn btn-success waves-effect waves-light me-2">Kembali</a>
