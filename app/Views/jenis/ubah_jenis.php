                            ...
                            <form action="<?= base_url('jenis/update/'.$jenis['id']) ?>" method="post">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" name="jenis_mutasi" value="<?= $jenis['jenis_mutasi'] ?>" type="text" id="jenis_mutasi" required>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-end">
                                        <a href="<?= base_url('jenis') ?>" class="btn btn-success waves-effect waves-light me-2">Kembali</a>
